...
warnings.filterwarnings("ignore")  # Do not show warnings for depreciated functions
...
crossTabWithPd1 = pd.crosstab(posNegData["employment_status"], posNegData["i3_health"], margins=False)  # Cross Tab analysis using pandas library
crossTabWithPd1
...
for i in namelist:
    crossTabWithPd1 = pd.crosstab(posNegData[i], posNegData["i3_health"], margins=False)
    negNum = crossTabWithPd1["Yes, and I tested negative"]
    posNum = crossTabWithPd1["Yes, and I tested positive"]
